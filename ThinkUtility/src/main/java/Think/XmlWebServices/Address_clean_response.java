...
public class Address_clean_response  implements java.io.Serializable {
    private Think.XmlWebServices.Customer_address_data customer_address_data;

    public Address_clean_response() {
    }
    ...
    /**
     * Gets the customer_address_data value for this Address_clean_response.
     * 
    ...
    /**
     * Sets the customer_address_data value for this Address_clean_response.
     * 
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof Address_clean_response)) return false;
        Address_clean_response other = (Address_clean_response) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(Address_clean_response.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://Think/XmlWebServices/", ">address_clean_response"));
