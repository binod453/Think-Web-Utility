...
public class Attachment_edit_request  implements java.io.Serializable {
    private Think.XmlWebServices.User_login_data user_login_data;

    private Think.XmlWebServices.Attachment_data attachment_data;
    ...
    public Attachment_edit_request() {
    }

    public Attachment_edit_request(
           Think.XmlWebServices.User_login_data user_login_data,
           Think.XmlWebServices.Attachment_data attachment_data,
    ...
    /**
     * Gets the user_login_data value for this Attachment_edit_request.
     * 
    ...
    /**
     * Sets the user_login_data value for this Attachment_edit_request.
     * 
    ...
    /**
     * Gets the attachment_data value for this Attachment_edit_request.
     * 
     * @return attachment_data
     */
    public Think.XmlWebServices.Attachment_data getAttachment_data() {
        return attachment_data;
    }


    /**
     * Sets the attachment_data value for this Attachment_edit_request.
     * 
     * @param attachment_data
     */
    public void setAttachment_data(Think.XmlWebServices.Attachment_data attachment_data) {
        this.attachment_data = attachment_data;
    }


    /**
     * Gets the dsn value for this Attachment_edit_request.
     * 
     * @return dsn
     */
    ...
    /**
     * Sets the dsn value for this Attachment_edit_request.
     * 
     * @param dsn
     */
    ...
    /**
     * Gets the submit value for this Attachment_edit_request.
     * 
     * @return submit
     */
    ...
    /**
     * Sets the submit value for this Attachment_edit_request.
     * 
     * @param submit
     */
    ...
    /**
     * Gets the doc_ref_id value for this Attachment_edit_request.
     * 
     * @return doc_ref_id
     */
    ...
    /**
     * Sets the doc_ref_id value for this Attachment_edit_request.
     * 
     * @param doc_ref_id
     */
    ...
    /**
     * Gets the check_missing_fields value for this Attachment_edit_request.
     * 
    ...
    /**
     * Sets the check_missing_fields value for this Attachment_edit_request.
     * 
    ...
    /**
     * Gets the suppress_events value for this Attachment_edit_request.
     * 
    ...
    /**
     * Sets the suppress_events value for this Attachment_edit_request.
     * 
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof Attachment_edit_request)) return false;
        Attachment_edit_request other = (Attachment_edit_request) obj;
        ...
        _equals = true && 
            ...
            ((this.attachment_data==null && other.getAttachment_data()==null) || 
             (this.attachment_data!=null &&
              this.attachment_data.equals(other.getAttachment_data()))) &&
    ...
    public synchronized int hashCode() {
        ...
        if (getAttachment_data() != null) {
            _hashCode += getAttachment_data().hashCode();
        }
        if (getDsn() != null) {
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(Attachment_edit_request.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://Think/XmlWebServices/", ">attachment_edit_request"));
        ...
        elemField.setFieldName("attachment_data");
        elemField.setXmlName(new javax.xml.namespace.QName("http://Think/XmlWebServices/", "attachment_data"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://Think/XmlWebServices/", ">attachment_data"));
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
    }
