...
public class Customer_clear_response  implements java.io.Serializable {
    private Think.XmlWebServices.Customer customer;

    private Think.XmlWebServices.Payment[] payment;

    public Customer_clear_response() {
    }
    ...
    /**
     * Gets the customer value for this Customer_clear_response.
     * 
     * @return customer
     */
    ...
    /**
     * Sets the customer value for this Customer_clear_response.
     * 
     * @param customer
     */
    ...
    /**
     * Gets the payment value for this Customer_clear_response.
     * 
     * @return payment
     */
    ...
    /**
     * Sets the payment value for this Customer_clear_response.
     * 
     * @param payment
     */
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof Customer_clear_response)) return false;
        Customer_clear_response other = (Customer_clear_response) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(Customer_clear_response.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://Think/XmlWebServices/", ">customer_clear_response"));
