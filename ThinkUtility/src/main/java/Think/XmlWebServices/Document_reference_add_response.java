/**
 * Document_reference_add_response.java
 *
...
public class Document_reference_add_response  implements java.io.Serializable {
    private Think.XmlWebServices.ZZDocumentReference document_reference;

    public Document_reference_add_response() {
    }
    ...
    /**
     * Gets the document_reference value for this Document_reference_add_response.
     * 
    ...
    /**
     * Sets the document_reference value for this Document_reference_add_response.
     * 
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof Document_reference_add_response)) return false;
        Document_reference_add_response other = (Document_reference_add_response) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(Document_reference_add_response.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://Think/XmlWebServices/", ">document_reference_add_response"));
