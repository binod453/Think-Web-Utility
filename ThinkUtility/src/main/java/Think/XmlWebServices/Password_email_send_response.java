/**
 * Password_email_send_response.java
 *
...
public class Password_email_send_response  implements java.io.Serializable {
    private Think.XmlWebServices.Customer_login customer_login;

    public Password_email_send_response() {
    }
    ...
    /**
     * Gets the customer_login value for this Password_email_send_response.
     * 
    ...
    /**
     * Sets the customer_login value for this Password_email_send_response.
     * 
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof Password_email_send_response)) return false;
        Password_email_send_response other = (Password_email_send_response) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(Password_email_send_response.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://Think/XmlWebServices/", ">password_email_send_response"));
