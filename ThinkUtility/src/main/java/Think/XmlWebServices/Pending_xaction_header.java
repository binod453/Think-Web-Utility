...
public class Pending_xaction_header  extends Think.XmlWebServices.ZZPendingXactionHeader  implements java.io.Serializable {
    private Think.XmlWebServices.ZZPendingXaction[] pending_xaction;

    public Pending_xaction_header() {
    }
    ...
    public Pending_xaction_header(
           ...
           int xcnt_single,
           int xcnt_sub,
           Think.XmlWebServices.ZZPendingXaction[] pending_xaction) {
        super(
    ...
    /**
     * Gets the pending_xaction value for this Pending_xaction_header.
     * 
     * @return pending_xaction
     */
    public Think.XmlWebServices.ZZPendingXaction[] getPending_xaction() {
        return pending_xaction;
    }


    /**
     * Sets the pending_xaction value for this Pending_xaction_header.
     * 
     * @param pending_xaction
     */
    public void setPending_xaction(Think.XmlWebServices.ZZPendingXaction[] pending_xaction) {
        this.pending_xaction = pending_xaction;
    }

    public Think.XmlWebServices.ZZPendingXaction getPending_xaction(int i) {
        return this.pending_xaction[i];
    }

    public void setPending_xaction(int i, Think.XmlWebServices.ZZPendingXaction _value) {
        this.pending_xaction[i] = _value;
    }

    private java.lang.Object __equalsCalc = null;
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof Pending_xaction_header)) return false;
        Pending_xaction_header other = (Pending_xaction_header) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(Pending_xaction_header.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://Think/XmlWebServices/", ">pending_xaction_header"));
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("http://Think/XmlWebServices/", "pending_xaction"));
