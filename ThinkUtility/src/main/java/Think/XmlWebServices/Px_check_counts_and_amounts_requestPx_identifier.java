/**
 * Px_check_counts_and_amounts_requestPx_identifier.java
 *
...
public class Px_check_counts_and_amounts_requestPx_identifier  extends Think.XmlWebServices.ZZPXIdentifier  implements java.io.Serializable {
    private Think.XmlWebServices.ZZBoolean latest_open_for_internet;  // attribute

    public Px_check_counts_and_amounts_requestPx_identifier() {
    }
    ...
    /**
     * Gets the latest_open_for_internet value for this Px_check_counts_and_amounts_requestPx_identifier.
     * 
    ...
    /**
     * Sets the latest_open_for_internet value for this Px_check_counts_and_amounts_requestPx_identifier.
     * 
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof Px_check_counts_and_amounts_requestPx_identifier)) return false;
        Px_check_counts_and_amounts_requestPx_identifier other = (Px_check_counts_and_amounts_requestPx_identifier) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(Px_check_counts_and_amounts_requestPx_identifier.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://Think/XmlWebServices/", ">>px_check_counts_and_amounts_request>px_identifier"));
