/**
 * Px_replace_responsePending_xaction_header.java
 *
...
public class Px_replace_responsePending_xaction_header  extends Think.XmlWebServices.ZZPendingXactionHeader  implements java.io.Serializable {
    private Think.XmlWebServices.Px_replace_responsePending_xaction_headerPending_xaction[] pending_xaction;

    public Px_replace_responsePending_xaction_header() {
    }
    ...
    public Px_replace_responsePending_xaction_header(
           ...
           int xcnt_single,
           int xcnt_sub,
           Think.XmlWebServices.Px_replace_responsePending_xaction_headerPending_xaction[] pending_xaction) {
        super(
    ...
    /**
     * Gets the pending_xaction value for this Px_replace_responsePending_xaction_header.
     * 
     * @return pending_xaction
     */
    public Think.XmlWebServices.Px_replace_responsePending_xaction_headerPending_xaction[] getPending_xaction() {
        return pending_xaction;
    }


    /**
     * Sets the pending_xaction value for this Px_replace_responsePending_xaction_header.
     * 
     * @param pending_xaction
     */
    public void setPending_xaction(Think.XmlWebServices.Px_replace_responsePending_xaction_headerPending_xaction[] pending_xaction) {
        this.pending_xaction = pending_xaction;
    }

    public Think.XmlWebServices.Px_replace_responsePending_xaction_headerPending_xaction getPending_xaction(int i) {
        return this.pending_xaction[i];
    }

    public void setPending_xaction(int i, Think.XmlWebServices.Px_replace_responsePending_xaction_headerPending_xaction _value) {
        this.pending_xaction[i] = _value;
    }

    private java.lang.Object __equalsCalc = null;
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof Px_replace_responsePending_xaction_header)) return false;
        Px_replace_responsePending_xaction_header other = (Px_replace_responsePending_xaction_header) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(Px_replace_responsePending_xaction_header.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://Think/XmlWebServices/", ">>px_replace_response>pending_xaction_header"));
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("http://Think/XmlWebServices/", ">>>px_replace_response>pending_xaction_header>pending_xaction"));
