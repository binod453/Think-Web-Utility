...
public class Px_update_response  implements java.io.Serializable {
    private Think.XmlWebServices.Pending_xaction_header pending_xaction_header;

    public Px_update_response() {
    }
    ...
    /**
     * Gets the pending_xaction_header value for this Px_update_response.
     * 
    ...
    /**
     * Sets the pending_xaction_header value for this Px_update_response.
     * 
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof Px_update_response)) return false;
        Px_update_response other = (Px_update_response) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(Px_update_response.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://Think/XmlWebServices/", ">px_update_response"));
