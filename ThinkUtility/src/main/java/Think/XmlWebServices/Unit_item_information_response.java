/**
 * Unit_item_information_response.java
 *
...
public class Unit_item_information_response  implements java.io.Serializable {
    private Think.XmlWebServices.Unit_order_item_informationOrder_item[] unit_order_item_information;

    public Unit_item_information_response() {
    }
    ...
    /**
     * Gets the unit_order_item_information value for this Unit_item_information_response.
     * 
    ...
    /**
     * Sets the unit_order_item_information value for this Unit_item_information_response.
     * 
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof Unit_item_information_response)) return false;
        Unit_item_information_response other = (Unit_item_information_response) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(Unit_item_information_response.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://Think/XmlWebServices/", ">unit_item_information_response"));
